...
func main() {
    ...
    params := gobo.Params{"sort": 1, "lat":34.19022, "long":108.84218, "range":11132}
...
//    err := weibo.Call("place/poi_timeline", "get", *access_token, params, &statuses)
    ...
    for _, status := range statuses.Statuses {
        ...
        comments := gobo.Params{"id": id, "comment": "测试一下，马上删除"	}
        err := weibo.Call("comments/create", "post", *access_token, comments, nil)
        if err != nil {
            fmt.Println(err)
        }
    }
